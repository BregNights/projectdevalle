...
public record PlatformSettingsResponse(BigDecimal commissionPercentage, List<CoverageRegionPayload> coverageRegions,
                                       List<String> enabledProductCategories) {

    public static PlatformSettingsResponse from(PlatformSettings settings) {
        return new PlatformSettingsResponse(settings.commissionPercentage(),
